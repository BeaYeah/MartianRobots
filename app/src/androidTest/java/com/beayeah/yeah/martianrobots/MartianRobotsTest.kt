...
import com.beayeah.yeah.martianrobots.screens.MainActivityScreen
...
class MartianRobotsTest {
    ...
    fun useAppContext() {
        ...
        assertEquals("com.beayeah.yeah.martianrobots", appContext.packageName)
    }
...
"""
    ...
    private val commandMoreThan100Characters =
        "sadfasdfhadsjkfhasdfjkshdfjkahsdfjkhsdfjweurfhafnasidnviosdfsgdsfgdfsadnvsadfasdfisadjfsjdfoijsdfijsdfoisajdfojaisdfadosfijifj"
    private val tooLargeCoordinateError =
        "Failed at line 2 - The value for any co-ordinate cannot be higher than 50 or lower than 0"
